package com.example.hasee.mycamera;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener,SurfaceHolder.Callback{
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (mpreviewRunning){
            ...
            mCamere.setPreviewDisplay(holder);
            mCamere.stopPreview();
    ...
    public void onClick(View v) {
        if (mpreviewRunning){
            ...
            mCamere.autoFocus(new Camera.AutoFocusCallback() {
                @Override
                public void onAutoFocus(boolean success, Camera camera) {
                    mCamere.takePicture(mShutterCallback,null,mPictureCallback);
                }
            });
        }
    }
    ...
    public void setCameraParams(){
        ...
        mCamere=Camera.open();
        Camera.Parameters params = mCamere.getParameters();
